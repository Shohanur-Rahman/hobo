                            ...
                            <table class="cart-table">
                                ...
                                @foreach($wishLists as $wishList)
                                    ...
                                    <tr class="cart-row">
                                        ...
                                        <td>
                                            <span class="cart-product-price">${{$wishList->product->new_price}}</span>
                                        ...
                                        <td>
                                            <div class="cart-quantity-changer">
                                                ...
                                                <input type="number" name="quantity[]" min="1"
                                                       value="{{$wishList->quantity}}" onchange="CalculateTotal(this)"
                                                       id="qty_{{$wishList->id}}" selector="{{$wishList->id}}"
                                                       pattern="[0-9]" onkeydown="CalculateTotal(this)"
                                                       onkeyup="CalculateTotal(this)" onkeyup="CalculateTotal(this)"/>
                                            </div>
                                        </td>
                                        <td>
