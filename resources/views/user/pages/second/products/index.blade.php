                        ...
                        <div class="white-bg px-4 py-4">
                            ...
                            <ul class="list-none mt-25">
                                <li class="{{request()->query('brand') == 0 ? 'active' : ''}}" data-id="0">
                                    <a href="{{route('product.index', $categoryDetails->slug).generateQueryString('brand', 0)}}">All
                                        Brands</a>
                                </li>
                        ...
                        <div class="white-bg px-4 py-4">
                            ...
                            <ul class="list-none mt-25">
                                <li class="{{request()->query('color') == 0 ? 'active' : ''}}" data-id="0">
                                    <a href="{{route('product.index', $categoryDetails->slug).generateQueryString('color', 0)}}">All
                                        Colors</a>
                                </li>
                        ...
                        <div class="white-bg px-4 py-4">
                            ...
                            <ul class="list-none mt-25">
                                <li class="{{request()->query('size') == 0 ? 'active' : ''}}" data-id="0">
                                    <a href="{{route('product.index', $categoryDetails->slug).generateQueryString('size', 0)}}">All
                                        Sizes</a>
                                </li>
            ...
            <div class="col-xl-9 col-lg-9">
                ...
                <div class="tab-content">
                    <div id="grid-products" class="tab-pane active">
                        <?php $itemCount = 1; ?>
                        <div
                            class="row {{request()->is('*male*') ? 'male-products' : ''}} {{request()->is('*female*') ? 'female-products' : ''}}">
                            ...
                            @foreach($products as $product)
                                ...
                                @endphp
                                <div class="col-xl-4 col-md-4 col-sm-6" title="{{$product->title}}">
                                    <div class="flip-box">
                                                ...
                                                <div class="product-front-box">
                                                    <h4 class="product-title-name">
                                                        <a title="{{$product->title}}"
                                                           href="{{route('product.details', ["category" => $categoryDetails->slug ,"slug" => $product->slug])}}">{{$product->title}}</a>
                                                    </h4>
                                                    <a href="{{route('product.details', ["category" => $categoryDetails->slug ,"slug" => $product->slug])}}">
                                                        <img class="product-item-listed-image"
