<meta charset="utf-8">
	...
	<!-- elegant css -->
	<link rel="stylesheet" href="{{asset('user/assets/css/elegant.css')}}">
	<!-- elegant css -->
	<link rel="stylesheet" href="{{asset('user/assets/css/jquery.mmenu.css')}}">
	<!-- jquery-ui.min css -->
	<link rel="stylesheet" href="{{asset('user/assets/css/jquery-ui.min.css')}}">
	<!-- venobox css -->
	<link rel="stylesheet" href="{{asset('user/assets/css/venobox.css')}}">
	<!-- slick css -->
