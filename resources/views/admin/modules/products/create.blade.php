                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="title"
                                                       placeholder="Product title" name="title" required="required"
                                                       data-parsley-error-message="Product title is required"
                                                       maxlength="200"/>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-3">
                                            <div class="form-group">
                                                ...
                                                <input class="currancy_touchspin" type="text" name="old_price"
                                                       id="old_price"/>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-3">
                                            <div class="form-group">
                                                ...
                                                <input class="currancy_touchspin" type="text" name="new_price"
                                                       id="new_price"/>
                                        ...
                                        <div class="col-sm-3">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control rounded-0 form-control-md" type="date"
                                                       id="available_start_date" name="available_start_date"/>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-3">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control rounded-0 form-control-md" type="date"
                                                       id="available_end_date" name="available_end_date"/>
                                            </div>
                                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="kendo_editor" rows="6" id="description"
                                                  placeholder="Sort Description" name="description" required="required"
                                                  data-parsley-error-message="Enter product description"> </textarea>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <input type="file" name="imgInp" class="hdn-uploder" id="imgInp"
                                               ...
                                               data-parsley-error-message="Upload featured image"/>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <select id="brand_id" class="form-control" name="brand_id"
                                                data-parsley-error-message="Choose your brand id">
                                ...
                                <div class="col-sm-3 col-xs-3">
                                    <div class="form-group">
                                        ...
                                        <select id="mltSize" class="form-control" data-placeholder="Size"
                                                data-parsley-error-message="Choose product Size">
                                ...
                                <div class="col-sm-3 col-xs-3">
                                    <div class="form-group">
                                        ...
                                        <select id="mltColor" class="form-control"
                                                data-placeholder="Select at least one tag" required="required"
                                                data-parsley-error-message="Choose at least one tag">
                                ...
                                <div class="col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <select id="mltCategories" class="form-control"
                                                data-placeholder="Select at least one category" required="required"
                                                data-parsley-error-message="Choose at least one category">
                                            @foreach($categories as $category)
                                                <option value="{{$category->id}}">{{$category->category_name}} <b
                                                        class="text-black-50">({{$category->user->user_type}})</b>
                                                </option>
                                                @foreach($category->childrens as $children)
                                                    <option value="{{$children->id}}"> {{$category->category_name}}
                                                        ->{{$children->category_name}} <b
                                                            class="text-black-50">({{$category->user->user_type}})</b>
                                                    </option>

                                                    @foreach($children->childrens as $leaveItem)
                                                        <option value="{{$leaveItem->id}}"> {{$category->category_name}}
                                                            ->{{$children->category_name ." -> " . $leaveItem->category_name}}
                                                            <b class="text-black-50">({{$category->user->user_type}}
                                                                )</b></option>
                                                    @endforeach
                                ...
                                <div class="col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <select id="mltTags" class="form-control"
                                                data-placeholder="Select at least one tag" required="required"
                                                data-parsley-error-message="Choose at least one tag">
                                            @foreach($tags as $cat)
                                                <option value="{{$cat->id}}">{{$cat->name}}</option>
                            ...
                            <div class="row">
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <input class="currancy_touchspin" type="text" name="shipping_charge"
                                               value="0" id="shipping_charge" required/>
                                        <span class="parsley-errors-list filled" id="error"></span>
                                    </div>
                                </div>
                                <div class="col-sm-3">
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <select id="delivery_id" class="form-control" name="delivery_id" required="required"
                                                data-parsley-error-message="Choose your Delivery Time">
                                            <option value="">-- Select One --</option>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <select id="availability_id" class="form-control dummy_inventory_control"
                                                name="availability_id" required="required"
                                                data-parsley-error-message="Choose your store id">
                                            <option value="">-- Select One --</option>
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <input class="number_touchspin dummy_inventory_control" type="text"
                                               name="inventory_qty" id="inventory_qty" required="required"
                                               data-parsley-errors-container=".qtyError"/>
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <input class="number_touchspin dummy_inventory_control" type="text"
                                               name="minimum_inventory_qty" id="minimum_inventory_qty" value="1"
                                               required="required"/>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <select id="Warehouse_id" class="form-control dummy_inventory_control"
                                                name="Warehouse_id" required="required"
                                                data-parsley-error-message="Choose your store id">
                                            <option value="">-- Select One --</option>
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <input class="number_touchspin dummy_inventory_control" type="text"
                                               name="minimum_cart_qty" id="minimum_cart_qty" value="1"
                                               required="required"/>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        <div class="new-checkbox">
                                            <div class="inline-widged">
                                                <label for="show_availability" class="single-label">Show
                                                    Availability</label>
                                                <label class="switch">
                                                    <input type="checkbox" class="availability_checkbox"
                                                           id="show_availability" name="show_availability"/>
                                                    <span class="slider round"></span>
                                                </label>
                                            </div>
                                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input class="dummy_seo_control form-control" type="text" name="meta_keywords"
                                               id="meta_keywords" required="required"/>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input class="dummy_seo_control form-control" type="text"
                                               name="meta_description" id="meta_description" required="required"/>
                                    </div>
                                </div>
                        ...
                        <div class="card-footer">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <button type="submit" id="submitProduct" class="btn btn-primary mr-2 float-right">
                                        Save Product
                                    </button>
                                </div>
                            </div>
