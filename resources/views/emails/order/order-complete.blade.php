                ...
                <table class="es-content" cellspacing="0" cellpadding="0" align="center">
                    ...
                    <tr>
                        <td class="esd-stripe" esd-custom-block-id="7681" align="center">
                            <table class="es-header-body" style="background-color: #044767;" width="600" cellspacing="0"
                                   cellpadding="0" bgcolor="#044767" align="center">
                                <tbody>
                                <tr>
                                    <td class="esd-structure" align="left"
                                        style="padding-right: 35px; padding-bottom: 35px; padding-top: 35px; padding-left: 35px;">
                                        <!--[if mso]>
                                                    ...
                                                    <table width="100%" cellspacing="0" cellpadding="0">
                                                        ...
                                                        <tr>
                                                            <td class="esd-block-text es-m-txt-c" align="left">
                                                                <h1 style="color: #ffffff; line-height: 100%;">HOBO</h1>
                                                            </td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
                                                            ...
                                                            <td>
                                                                <table cellspacing="0" cellpadding="0" align="right">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="esd-block-image es-p10l" valign="top"
                                                                            align="left"
                                                                            style="font-size:0; padding-top: 20px;"><a
                    ...
                    <tr>
                        <td class="esd-stripe" align="center">
                            <table class="es-content-body" width="600" cellspacing="0" cellpadding="0" bgcolor="#ffffff"
                                ...
                                <tr>
                                    <td class="esd-structure" align="left"
                                        style="padding-right: 35px; padding-left: 35px; padding-top: 40px;">
                                        <table width="100%" cellspacing="0" cellpadding="0">
                                            <tbody>
                                            <tr>
                                                <td class="esd-container-frame" width="530" valign="top" align="center">
                                                    <table width="100%" cellspacing="0" cellpadding="0">
                                                        <tbody>
                                                        <tr>
                                                            <td class="esd-block-image es-p25t es-p25b" align="center"
                                                                style="font-size:0; padding-right: 35px; padding-left: 35px;">
                                                                <a target="_blank" href="https://viewstripo.email/"><img
                                                                        src="https://tlr.stripocdn.email/content/guids/CABINET_75694a6fc3c4633b3ee8e3c750851c02/images/67611522142640957.png"
                                                                        alt style="display: block;" width="120"></a>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            <td class="esd-block-text es-p15t es-p20b" align="left">
                                                                <p style="font-size: 16px; color: #777777;">Thank you
                                                                    for your order. Your order has been under review. We
                                                                    will deliver
                                                                    your order at estimate time.<br>
                                                                </p>
                                                            </td>
                                                        </tr>
                                                        </tbody>
                    ...
                    <tr>
                        <td class="esd-stripe" align="center">
                            <table class="es-content-body" width="600" cellspacing="0" cellpadding="0" bgcolor="#ffffff"
                                                        ...
                                                        <tr>
                                                            <td class="esd-block-text es-p10t es-p10b es-p10r es-p10l"
                                                                ...
                                                                <table style="width: 500px;" class="cke_show_border"
                                                                    ...
                                                                    <tr>
                                                                        <td width="80%">
                                                                            <h4 style="font-weight: bold; margin: 5px;">
                                                        ...
                                                        <tr>
                                                            <td class="esd-block-text es-p10t es-p10b es-p10r es-p10l"
                                                                ...
                                                                <table style="width: 500px;" class="cke_show_border"
                                                                    ...
                                                                    @foreach($data['orders'] as $cartItem)
                                                                        <tr>
                                ...
                                <tr>
                                    <td class="esd-structure es-p10t" align="left"
                                        style="padding-right: 35px; padding-left: 35px;">
                                        <table width="100%" cellspacing="0" cellpadding="0">
                                            <tbody>
                                            <tr>
                                            ...
                                            <tr>
                                                <td class="esd-stripe" esd-custom-block-id="7797" align="center">
                                                    <table class="es-content-body" style="background-color: #1b9ba3;"
                                                        ...
                                                        <tr>
                                                            <td class="esd-structure" align="left"
                                                                style="padding-right: 35px; padding-left: 35px; padding-bottom: 35px; padding-top: 35px;">
                                ...
                                <tr>
                                    <td class="esd-structure" esd-custom-block-id="7796" align="left"
                                        style="padding-right: 35px; padding-left: 35px; padding-top: 40px; padding-bottom: 40px;">
                                        <!--[if mso]>
                                        <table width="530" cellpadding="0" cellspacing="0">
                                            <tr>
                                                    ...
                                                    <table width="100%" cellspacing="0" cellpadding="0">
                                                        ...
                                                        <tr>
                                                            <td class="esd-block-text es-p10b" align="left">
                                                                <p>{{$data['shipping']->name}}<br/>
                                                                {{$data['shipping']->email}}<br/>
                                                                {{$data['shipping']->phone}}<br/>
                                                                {{$data['shipping']->house . ' ' . $data['shipping']->road . ' ' .
                                                                $data['shipping']->postcode . ' ' .$data['shipping']->state . ' ' .$data['shipping']->city. ' ' .$data['shipping']->country }}</p>
                                                                <p>{{$data['shipping']->describe_address}}</p>
                                                            </td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
                                                    ...
                                                    <table width="100%" cellspacing="0" cellpadding="0">
                                                        ...
                                                        <tr>
                                                            <td class="esd-block-text" align="left">
                                                                <p>{{Carbon\Carbon::today()->addDays(7)->format('d F Y')}}</p>
                                                            </td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
