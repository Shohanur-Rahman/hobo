                                            ...
                                            <tr>
                                                <td class="esd-container-frame" width="600" valign="top" align="center">
                                                    <table style="background-color: #ffffff; border-radius: 4px; border-collapse: separate;" width="100%" cellspacing="0" cellpadding="0" bgcolor="#ffffff">
                                                        ...
                                                        <tr>
                                                            <td class="esd-block-text es-p35t es-p5b es-p30r es-p30l" align="center">
                                                                Case Type:  {{$data['case_type_id']}}
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td class="esd-block-text es-p35t es-p5b es-p30r es-p30l" align="center">
                                                               Case Category: {{$data['case_category_id']}}
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td class="esd-block-text es-p35t es-p5b es-p30r es-p30l" align="center">
                                            ...
                                            <tr>
                                                <td class="esd-container-frame" width="600" valign="top" align="center">
                                                    <table style="border-radius: 4px; border-collapse: separate; background-color: #ffffff;" width="100%" cellspacing="0" cellpadding="0" bgcolor="#ffffff">
                                                        ...
                                                        <tr>
                                                            <td class="esd-block-button es-p35t es-p35b es-p10r es-p10l" align="center"><span class="es-button-border"><h1>User Waiting for Reply... </span></td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            <td class="esd-block-text es-p20t es-p30r es-p30l es-m-txt-l" align="left"><a target="_blank" href="https://viewstripo.email/">XXX.XXXXXXX.XXX / XXXXXXXXXXXXX</a></td>
                                                        </tr>
                                                        <tr>
                                                            <td class="esd-block-text es-p20t es-p30r es-p30l es-m-txt-l" align="left">
                                                    ...
                                                    <table width="100%" cellspacing="0" cellpadding="0">
                                                        ...
                                                        <tr>
                                                            <td class="esd-block-text" align="left">
                                                                <p><strong><a target="_blank" href="https://viewstripo.email">Dashboard</a> - <a target="_blank" href="https://viewstripo.email">Billing</a> - <a target="_blank" href="https://viewstripo.email">Help</a></strong></p>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td align="left" class="esd-block-text es-p25t">
                                                                <p>You received this email because you just signed up for a new account. If it looks weird, <strong><a class="view" target="_blank" href="https://viewstripo.email">view it in your browser</a></strong>.</p>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td align="left" class="esd-block-text es-p25t">
                                                                <p>If these emails get annoying, please feel free to&nbsp;<strong><a target="_blank" class="unsubscribe" href>unsubscribe</a></strong>.</p>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td class="esd-block-text es-p25t" align="left">
                                                                <p>Ceej - 1234 Main Street - Anywhere, MA - 56789</p>
                                                            </td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
